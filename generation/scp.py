...
parser.add_argument("--scp_mode", type=str, default='scp-random', help="scp-random or scp-select")
...
RESULTS_DIR = f"./results/gen{args.gen_model}/{args.scp_mode}/designed_TCRs"
...
if args.scp_mode == 'scp-random':
    bap_threshold = 0.0
    gpt_threshold = 0.0
elif args.scp_mode == 'scp-select':
...
for EPITOPE in epitopes:
    ...
    df_tcrs = pd.read_csv(f'./results/gen{args.gen_model}/scp-chain/designed_TCRs/{EPITOPE}_0_tcrs_prompting.csv')
