...
RESULTS_DIR = f"./results/gen{args.gen_model}/fsp-oracle/designed_TCRs"
...
for EPITOPE in epitopes:
    ...
    df_tcrs = pd.read_csv(f'./../data/combined_dataset_repTCRs.csv')
    df_tcrs = df_tcrs.head(150008)
    
    # Convert the filtered TCRs to a list
    selected_tcrs = df_tcrs[df_tcrs['epi'] == EPITOPE]['tcr'].to_list()
